...
(function () {
    ...
    function loadSettings() {
        try {
            return { ...defaults, ...(JSON.parse(localStorage.getItem(PREFIX + 'settings')) || {}) };
        } catch {
            return { ...defaults };
        }
    }
    ...
    async function copyMember(member, button) {
        // Freeze the exact message at the moment Copy is pressed. Subsequent
        // status changes, including leaving the hospital, do not alter or cancel it.
